...
public class SyntaxHighlighter : IDisposable {
    ...
    public virtual void TASSyntaxHighlight(Range range) {
        ...
        while (start <= end) {
            ...
            if (InputFrame.InputFrameRegex.IsMatch(line.Text)) {
            ...
            } else if (InputFrame.BreakpointRegex.IsMatch(line.Text)) {
                ...
                line.SetStyle(CommentStyle, InputFrame.CommentLineRegex);
